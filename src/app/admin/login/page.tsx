...
const REASON_MESSAGES: Record<string, string> = {
  "not-authorized":
    "Cet email n'est pas (encore) autorisé. Demande à un super-admin de t'ajouter.",
  "domain-not-allowed":
    "Cet espace est réservé aux membres @les-pilotes.fr. Connecte-toi avec ton compte Google professionnel.",
  "auth-unavailable":
      ...
      <div className="w-full max-w-sm space-y-10">
        <header className="space-y-1">
          ...
          <p className="text-sm text-stone-500">
            Espace réservé aux membres Les Pilotes.
          </p>
        </header>
